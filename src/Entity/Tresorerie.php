...
class Tresorerie
{
    ...
    public function getClientPrestataire(): ?string
    {
        return $this->client_prestataire;
    }

    public function setClientPrestataire(?string $client_prestataire): self
    {
        $this->client_prestataire = $client_prestataire;
