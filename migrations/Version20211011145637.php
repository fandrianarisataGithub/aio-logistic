 ...
 */
final class Version20211011145637 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE details_offer ADD company_confirmation VARCHAR(255) DEFAULT NULL, ADD sector VARCHAR(255) DEFAULT NULL, ADD id_pro VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE details_offer DROP company_confirmation, DROP sector, DROP id_pro');
