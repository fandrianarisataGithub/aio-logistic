 ...
 */
final class Version20220203144133 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trans_carburant_sortie ADD chauffeur_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_87F580D285C0B3BE ON trans_carburant_sortie (chauffeur_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_87F580D285C0B3BE ON trans_carburant_sortie');
        $this->addSql('ALTER TABLE trans_carburant_sortie DROP chauffeur_id');
    }
}
