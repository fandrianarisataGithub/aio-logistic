 ...
 */
final class Version20220325104627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trans_intervention CHANGE vehicule_id vehicule_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trans_intervention CHANGE vehicule_id vehicule_id INT DEFAULT NULL');
