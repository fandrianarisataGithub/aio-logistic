 ...
 */
final class Version20220211082220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trans_voyage CHANGE chauffeur chauffeur_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trans_voyage CHANGE chauffeur_id chauffeur INT NOT NULL');
    }
}
